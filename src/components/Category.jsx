  ...
  return (
    <div className="max-w-[1200px] md:mx-auto gap-5 mx-2">
      <div className="flex flex-col my-5 items-center justify-between md:flex-row">
        <div className="text-4xl md:text-left text-center my-5 font-bold leading-12 tracking-tight text-gray-700">
          What's on your mind?
        </div>
        <div className="flex">
          <div
      ...
      <div className="flex overflow-hidden my-9">
        {Category.map((item) => (
          <div
            key={item.idCategory}
            className="w-[200px] shrink-0 flex items-center justify-center mx-4"
          ...
          >
            <div className="flex-col flex items-center">
              ...
              <div className="text-2xl text-stone-500 font-medium">
                {item.strCategory}
              </div>
            </div>
          </div>
